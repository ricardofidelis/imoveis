					...
					<div class="container">
						...
						<div class="nav-collapse collapse">
							...
							<?php if (isset($this->currentUser)) { ?>
								...
								<?php } ?>
								<li @if (isset($nav) && $nav=='imoveis') class="active"@endif><a href="./imoveis">Imoveis</a></li>
								<li @if (isset($nav) && $nav=='tipoimoveis') class="active"@endif><a href="./tipoimoveis">TipoImoveis</a></li>
								</ul>
								</li>
							</ul>
